...
def wireframe(bm, faces, thickness, offset, use_replace, use_boundary, use_even_offset, use_crease, crease_weight, thickness_2, use_relative_offset, material_offset):
    pass
