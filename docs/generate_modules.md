...
The generating script can be run on Python >= 3.10.
...
<!-- markdownlint-disable MD013 -->
```bash
PYTHON_BIN=/path/to/python3.10 bash gen_module.sh <source-dir> <blender-dir> <target> <branch/tag/commit> <target-version> <output-dir> [<mod-version>]
```
<!-- markdownlint-enable MD013 -->
