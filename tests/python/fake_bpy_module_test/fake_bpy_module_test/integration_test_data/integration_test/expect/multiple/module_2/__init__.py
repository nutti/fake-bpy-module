...
def function_1(
    ...
    arg_3: bpy.stub_internal.rna_enums.Enum1,
    arg_4: set[bpy.stub_internal.rna_enums.Enum1],
    arg_5: bpy.stub_internal.rna_enums.Enum1,
    ...
    :type arg_3: bpy.stub_internal.rna_enums.Enum1
    :param arg_4: Enumerator in `rna_enum_enum1`.
    :type arg_4: set[bpy.stub_internal.rna_enums.Enum1]
    :param arg_5: job type in `rna_enum_enum1`.
    :type arg_5: bpy.stub_internal.rna_enums.Enum1
