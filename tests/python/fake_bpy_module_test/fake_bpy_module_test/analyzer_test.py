...
class AnalyzerWithModFileTest(common.FakeBpyModuleTestBase):
    ...
    def test_remove_constant(self):
        rst_files = ["input/multiple_constants.rst"]
    ...
    def test_remove_function(self):
        rst_files = ["input/multiple_functions.rst"]
        rst_files = [f"{self.data_dir}/{f}" for f in rst_files]
    ...
    def test_remove_class(self):
        rst_files = ["input/multiple_classes.rst"]
        rst_files = [f"{self.data_dir}/{f}" for f in rst_files]
    ...
    def test_new_constant(self):
        rst_files = ["input/single_constant.rst"]
        rst_files = [f"{self.data_dir}/{f}" for f in rst_files]
    ...
    def test_new_function(self):
        rst_files = ["input/single_function.rst"]
        rst_files = [f"{self.data_dir}/{f}" for f in rst_files]
    ...
    def test_new_class(self):
        rst_files = ["input/single_class.rst"]
        rst_files = [f"{self.data_dir}/{f}" for f in rst_files]
