...
def wireframe(bm, faces, thickness_2, offset, use_replace, use_boundary,
              use_even_offset, use_crease, crease_weight, thickness,
              use_relative_offset, material_offset):
