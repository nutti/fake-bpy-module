...
def collada_export(filepath="",
    ...
    :type export_transformation_type_selection: enum in ['matrix', 'transrotloc', 'both'], (optional)
...
def keyconfig_export(filepath="keymap.py",
                     filter_folder=True,
                     filter_text=True,
                     filter_python=True):
