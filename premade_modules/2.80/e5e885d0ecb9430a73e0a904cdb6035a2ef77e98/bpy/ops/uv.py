...
def lightmap_pack(PREF_CONTEXT='SEL_FACES',
    ...
    :type PREF_CONTEXT: enum in ['SEL_FACES', 'ALL_FACES'], (optional)
...
def select_box(pinned=False,
    ...
    :param mode: Mode 
    :type mode: enum in ['SET', 'ADD', 'SUB'], (optional)
    '''
...
def select_linked(extend=False, deselect=False):
...
def stitch(use_limit=False,
    ...
    :type active_object_index: int in [0, inf], (optional)
    ...
    :param objects_selection_count: objects_selection_count, objects_selection_count 
    :type objects_selection_count: int array of 6 items in [0, inf], (optional)
    '''
