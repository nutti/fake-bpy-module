def average_normals(average_type='CUSTOM_NORMAL', weight=50, threshold=0.01):
    ...
    :type average_type: enum in ['CUSTOM_NORMAL', 'FACE_AREA', 'CORNER_ANGLE'], (optional)
    :param weight: Weight, Weight applied per face 
    :type weight: int in [1, 100], (optional)
...
def bevel(offset_type='OFFSET',
    ...
    :type mark_seam: boolean, (optional)
    ...
    :param strength: Normal Strength, Strength of calculated normal 
    :type strength: float in [0, 1], (optional)
    :param hnmode: Normal Mode, Weighting mode for Harden NormalsHN_NONE Off, Do not use Harden Normals.HN_FACE Face Area, Use faces as weight.HN_ADJ Vertex average, Use adjacent vertices as weight. 
    :type hnmode: enum in ['HN_NONE', 'HN_FACE', 'HN_ADJ'], (optional)
...
def extrude_context(use_normal_flip=False, mirror=False):
    ...
    :type use_normal_flip: boolean, (optional)
...
def extrude_context_move(MESH_OT_extrude_context=None,
    ...
    :type MESH_OT_extrude_context: MESH_OT_extrude_context, (optional)
    :param TRANSFORM_OT_translate: Move, Move selected items 
    :type TRANSFORM_OT_translate: TRANSFORM_OT_translate, (optional)
    '''
...
def knife_tool(use_occlude_geometry=True,
               only_selected=False,
               wait_for_input=True):
    '''Cut new topology 
...
def loopcut(number_cuts=1,
    ...
    :type object_index: int in [-1, inf], (optional)
...
def normals_tools(mode='COPY', absolute=False):
    ...
    :type mode: enum in ['COPY', 'PASTE', 'ADD', 'MULTIPLY', 'RESET'], (optional)
...
def point_normals(mode='COORDINATES',
                  invert=False,
                  align=False,
    ...
    :type mode: enum in ['COORDINATES', 'MOUSE'], (optional)
...
def poke(offset=0.0, use_relative_offset=False, center_mode='MEDIAN_WEIGHTED'):
    ...
    :type center_mode: enum in ['MEDIAN_WEIGHTED', 'MEDIAN', 'BOUNDS'], (optional)
    '''
...
def polybuild_face_at_cursor(mirror=False,
...
def polybuild_face_at_cursor_move(MESH_OT_polybuild_face_at_cursor=None,
    ...
    :type MESH_OT_polybuild_face_at_cursor: MESH_OT_polybuild_face_at_cursor, (optional)
    :param TRANSFORM_OT_translate: Move, Move selected items 
    :type TRANSFORM_OT_translate: TRANSFORM_OT_translate, (optional)
    '''
...
def polybuild_split_at_cursor(mirror=False,
                              proportional='DISABLED',
                              proportional_edit_falloff='SMOOTH',
                              proportional_size=1.0,
                              release_confirm=False,
...
def polybuild_split_at_cursor_move(MESH_OT_polybuild_split_at_cursor=None,
    ...
    :type MESH_OT_polybuild_split_at_cursor: MESH_OT_polybuild_split_at_cursor, (optional)
    :param TRANSFORM_OT_translate: Move, Move selected items 
    :type TRANSFORM_OT_translate: TRANSFORM_OT_translate, (optional)
    '''
...
def primitive_circle_add(vertices=32,
                         radius=1.0,
                         fill_type='NOTHING',
                         calc_uvs=True,
                         view_align=False,
...
def primitive_cube_add(size=2.0,
                       calc_uvs=True,
                       view_align=False,
                       enter_editmode=False,
                       location=(0.0, 0.0, 0.0),
...
def primitive_cylinder_add(vertices=32,
                           radius=1.0,
                           depth=2.0,
                           end_fill_type='NGON',
                           calc_uvs=True,
...
def primitive_ico_sphere_add(subdivisions=2,
                             radius=1.0,
                             calc_uvs=True,
                             view_align=False,
                             enter_editmode=False,
...
def primitive_monkey_add(size=2.0,
                         calc_uvs=True,
                         view_align=False,
                         enter_editmode=False,
                         location=(0.0, 0.0, 0.0),
...
def primitive_plane_add(size=2.0,
                        calc_uvs=True,
                        view_align=False,
                        enter_editmode=False,
                        location=(0.0, 0.0, 0.0),
...
def primitive_torus_add(view_align=False,
                        location=(0.0, 0.0, 0.0),
                        rotation=(0.0, 0.0, 0.0),
                        major_segments=48,
                        minor_segments=12,
...
def primitive_uv_sphere_add(segments=32,
                            ring_count=16,
                            radius=1.0,
                            calc_uvs=True,
                            view_align=False,
...
def select_axis(orientation='LOCAL', sign='POS', axis='X', threshold=0.0001):
    ...
    :type orientation: enum in ['GLOBAL', 'LOCAL', 'NORMAL', 'GIMBAL', 'VIEW', 'CURSOR'], (optional)
    :param sign: Axis Sign, Side to select 
    :type sign: enum in ['POS', 'NEG', 'ALIGN'], (optional)
    :param axis: Axis, Select the axis to compare each vertex on 
    :type axis: enum in ['X', 'Y', 'Z'], (optional)
...
def select_similar(type='NORMAL', compare='EQUAL', threshold=0.0):
    ...
    :param type: Type 
    :type type: enum in ['NORMAL', 'FACE', 'VGROUP', 'EDGE', 'LENGTH', 'DIR', 'FACE', 'FACE_ANGLE', 'CREASE', 'BEVEL', 'SEAM', 'SHARP', 'FREESTYLE_EDGE', 'MATERIAL', 'AREA', 'SIDES', 'PERIMETER', 'NORMAL', 'COPLANAR', 'SMOOTH', 'FACE_MAP', 'FREESTYLE_FACE'], (optional)
...
def set_normals_from_faces(keep_sharp=False):
    ...
    :type keep_sharp: boolean, (optional)
    '''
...
def smoothen_normals(factor=0.5):
...
def spin(steps=9,
    ...
    :type use_auto_merge: boolean, (optional)
    :param use_normal_flip: Flip Normals 
    :type use_normal_flip: boolean, (optional)
    :param center: Center, Center in global view space 
    :type center: float array of 3 items in [-inf, inf], (optional)
